...
Map<String, dynamic> _$_$_PlayerCraftsToJson(_$_PlayerCrafts instance) =>
    <String, dynamic>{
      ...
      'Clothcraft': instance.clothcraft,
      'Cooking': instance.cooking,
      'Fishing': instance.fishing,
      'Goldsmithing': instance.goldsmithing,
      'Leathercraft': instance.leathercraft,
      'Smithing': instance.smithing,
      'Synergy': instance.synergy,
      'Woodworking': instance.woodworking,
    };
