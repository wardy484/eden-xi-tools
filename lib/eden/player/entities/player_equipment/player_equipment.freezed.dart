...
/// @nodoc
abstract class $PlayerEquipmentCopyWith<$Res> {
  factory $PlayerEquipmentCopyWith(
          PlayerEquipment value, $Res Function(PlayerEquipment) then) =
      _$PlayerEquipmentCopyWithImpl<$Res>;
  $Res call(
      {PlayerEquipmentSlot ammo,
      PlayerEquipmentSlot back,
      PlayerEquipmentSlot body,
...
/// @nodoc
class _$PlayerEquipmentCopyWithImpl<$Res>
    implements $PlayerEquipmentCopyWith<$Res> {
  _$PlayerEquipmentCopyWithImpl(this._value, this._then);

  final PlayerEquipment _value;
  // ignore: unused_field
  final $Res Function(PlayerEquipment) _then;
...
/// @nodoc
abstract class _$PlayerEquipmentCopyWith<$Res>
    implements $PlayerEquipmentCopyWith<$Res> {
  factory _$PlayerEquipmentCopyWith(
          _PlayerEquipment value, $Res Function(_PlayerEquipment) then) =
      __$PlayerEquipmentCopyWithImpl<$Res>;
  @override
  $Res call(
      {PlayerEquipmentSlot ammo,
      PlayerEquipmentSlot back,
...
/// @nodoc
class __$PlayerEquipmentCopyWithImpl<$Res>
    extends _$PlayerEquipmentCopyWithImpl<$Res>
    implements _$PlayerEquipmentCopyWith<$Res> {
  __$PlayerEquipmentCopyWithImpl(
      _PlayerEquipment _value, $Res Function(_PlayerEquipment) _then)
      : super(_value, (v) => _then(v as _PlayerEquipment));

  @override
  _PlayerEquipment get _value => super._value as _PlayerEquipment;
...
class _$_PlayerEquipment extends _PlayerEquipment {
  ...
  @override
  final PlayerEquipmentSlot back;
  @override
  final PlayerEquipmentSlot body;
  @override
  final PlayerEquipmentSlot ear1;
  @override
  final PlayerEquipmentSlot ear2;
  @override
  final PlayerEquipmentSlot feet;
  @override
  final PlayerEquipmentSlot hands;
  @override
  final PlayerEquipmentSlot head;
  @override
  final PlayerEquipmentSlot legs;
  @override
  final PlayerEquipmentSlot ls1;
  @override
  final PlayerEquipmentSlot ls2;
  @override
  final PlayerEquipmentSlot main;
  @override
  final PlayerEquipmentSlot neck;
  @override
  final PlayerEquipmentSlot ranged;
  @override
  final PlayerEquipmentSlot ring1;
  @override
  final PlayerEquipmentSlot ring2;
  @override
  final PlayerEquipmentSlot sub;
  @override
  final PlayerEquipmentSlot waist;

  @override
  String toString() {
    return 'PlayerEquipment(ammo: $ammo, back: $back, body: $body, ear1: $ear1, ear2: $ear2, feet: $feet, hands: $hands, head: $head, legs: $legs, ls1: $ls1, ls2: $ls2, main: $main, neck: $neck, ranged: $ranged, ring1: $ring1, ring2: $ring2, sub: $sub, waist: $waist)';
  }
